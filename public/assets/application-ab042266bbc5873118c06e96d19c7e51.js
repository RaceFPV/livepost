...
(function() {
  var CalendarDate, RelativeTimeAgo, browserIsCompatible, domLoaded, iso8601, months, pad, parse, process, strftime, update, weekdays;
  ...
  strftime = function(time, formatString) {
    ...
    return formatString.replace(/%([%aAbBcdeHIlmMpPSwyY])/g, function(_arg) {
      var match, modifier;
  ...
  RelativeTimeAgo = (function() {
    RelativeTimeAgo.generate = function(date) {
      return new this(date).toString();
    };
    ...
    RelativeTimeAgo.prototype.toString = function() {
      var ago, day;
    ...
    RelativeTimeAgo.prototype.timeElapsed = function() {
      var hr, min, ms, sec;
    ...
    RelativeTimeAgo.prototype.relativeWeekday = function() {
      var daysPassed;
    ...
    RelativeTimeAgo.prototype.formatDate = function() {
      var format;
      format = "%b %e";
    ...
    RelativeTimeAgo.prototype.formatTime = function() {
    ...
    process("time[data-local]:not([data-localized])", function(element) {
      ...
      return element[textProperty] = (function() {
        switch (local) {
          ...
          case "time-ago":
            return RelativeTimeAgo.generate(time);
        }
      })();
    });
  ...
  ga('create', 'UA-47880897-1', 'livepost.io');
  ga('send', 'pageview');
/*
 * Gritter for jQuery
